...
var sotf_link = document.createElement("a");
sotf_link.href = "http://" + document.domain + "/";
sotf_link.id = "sotf_link";
sotf_link.target = "_blank";
sotf_link.style.position = "absolute";
sotf_link.style.width="1px";
sotf_link.style.height="1px";
sotf_link.style.zIndex="99999";
document.getElementsByTagName("body")[0].appendChild(sotf_link);
...
{
  if(!e) e = window.event;
  var l = document.getElementById("sotf_link").style;
  l.left = e.clientX + "px";
  l.top = e.clientY + "px";
}